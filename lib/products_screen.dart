...
import 'product_groups_screen.dart'; // To reuse allProductGroupsProvider
...
class _ProductEditorDialogState extends ConsumerState<_ProductEditorDialog> {
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      if (_isEditing) {
        payload['id'] = widget.existingProduct!.id;
          ...
          child: Column(
            children: [
              ...
              Expanded(
                child: TabBarView(
                  children: [
                    // --- TAB 1: GENERAL INFO (FULLY MAPPED TO YOUR SCREENSHOTS) ---
                      ...
                      child: Form(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            // RIGHT COLUMN: Toggles, Colors, and Images
                            Expanded(
                              flex: 2,
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                    ...
                                    child: Column(
                                      children: [
                                        ...
                                        SwitchListTile(
                                            ...
                                            onChanged: (v) => setState(() =>
                                                _isPriceChangeAllowed = v),
                                            visualDensity:
                                                VisualDensity.compact),
                                        SwitchListTile(
                                            title: const Text(
                                                "Is Using Default Quantity"),
                                            value: _isUsingDefaultQuantity,
                                            onChanged: (v) => setState(() =>
                                                _isUsingDefaultQuantity = v),
                                            visualDensity:
                                                VisualDensity.compact),
                                        SwitchListTile(
                                            title: const Text(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          allTaxesAsync.when(
                              ...
                              error: (_, __) =>
                                  const Text("Failed to load taxes"),
                              data: (taxes) {
                    ...
                    // --- TAB 3: STOCK CONTROL (Placeholder) ---
                    const Center(
                        child:
                            Column(mainAxisSize: MainAxisSize.min, children: [
                      Icon(Icons.inventory, size: 64, color: Colors.grey),
                      SizedBox(height: 16),
                      Text("Stock Control Integration",
                          style: TextStyle(
                              fontSize: 18,
                              color: Colors.grey,
                              fontWeight: FontWeight.bold)),
                    ...
                    // --- TAB 5: COMMENTS (Placeholder) ---
                    const Center(
                        child:
                            Column(mainAxisSize: MainAxisSize.min, children: [
                      Icon(Icons.comment, size: 64, color: Colors.grey),
                      SizedBox(height: 16),
                      Text("Product Modifiers & Comments",
                          style: TextStyle(
                              fontSize: 18,
                              color: Colors.grey,
                              fontWeight: FontWeight.bold)),
